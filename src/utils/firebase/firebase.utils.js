...
export const createAuthUserWithEmailAndPassword = async (email, password) => {
  ...
  return await createUserWithEmailAndPassword(auth, email, password); // Fixed function call here (createUserWithEmailAndPassword instead of createAuthUserWithEmailAndPassword)
};